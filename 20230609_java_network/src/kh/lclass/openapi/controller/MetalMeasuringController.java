...
public class MetalMeasuringController {
	...
	public static void main(String[] args) throws IOException {
		...
		urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8")
				+ "=t0AUyWBLB4/6G8QnmNB9b9EFoBQkHSVO/L0Rdx6f4FbNjsi/D8jmfiKA6vxXbTS8N4zDjeYUpww2/g3LMoI0yQ=="); /*
																												 * Service
																												 * Key
																												 */
		urlBuilder
		...
		urlBuilder.append("&" + URLEncoder.encode("date", "UTF-8") + "="
				+ URLEncoder.encode("20171208", "UTF-8")); /* 검색조건 날짜 (예시 : 20171208) */
		urlBuilder.append("&" + URLEncoder.encode("stationcode", "UTF-8") + "="
				+ URLEncoder.encode("1", "UTF-8")); /* 검색조건 측정소코드 */
		urlBuilder.append("&" + URLEncoder.encode("itemcode", "UTF-8") + "="
				+ URLEncoder.encode("90303", "UTF-8")); /* 검색조건 항목코드 */
		urlBuilder.append("&" + URLEncoder.encode("timecode", "UTF-8") + "="
				+ URLEncoder.encode("RH02", "UTF-8")); /* 검색조건 시간구분 */
